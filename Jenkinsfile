pipeline {
    ...
    environment {
        SONARQUBE = 'MySonarServer'  // name from Jenkins config
         ...
         stage('Push Image to ECR'){
            steps {
                script {
                   ...
                   docker tag boardgame:latest $ACCOUNTID.dkr.ecr.ap-south-1.amazonaws.com/boardgame:latest
                   docker push $ACCOUNTID.dkr.ecr.ap-south-1.amazonaws.com/boardgame:latest
                '''
                }
            }
        }
